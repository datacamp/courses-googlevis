...
```{r, eval=FALSE, results="asis", cache=FALSE, echo=TRUE, tidy=FALSE}
...
if ( !exists("DM.result") ){
  ...
  DM.result = list(TRUE, "Wunderbar! We hope you enjoyed doing this demo on DataCamp. In the future we plan to do more courses on using interactive visualizations to analyze and present your data via R and googleVis. In the mean time, keep practicing, and maybe you can, sometime, share the stage with Hans Rosling.")
} else {
  DM.result = list(FALSE, "Have another look at your graph. Use the hint if you need extra help.")
}
```
