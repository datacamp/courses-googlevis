...
test_error()
success_msg("Isn't that beautiful! Probably the best stats you've ever seen. Again, play around with the graph and get a good understanding of what it represents. Then head over to the final question...")
```
