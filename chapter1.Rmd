...
--- type:VideoExercise aspect_ratio:0.5625 lang:r xp:50 skills:1
...
test_error()
success_msg("Isn't that beautiful! [Click here](http://s3.amazonaws.com/assets.datacamp.com/production/course_1007/datasets/final_output.html) for a full view. Probably the best stats you've ever seen. Again, play around with the graph and get a good understanding of what it represents. Then head over to the final question...")
```
...
*** =hint
You can still have a look at your interactive motion chart by typing `plot(motion_graph)` or `plot(motion_graph_log)` into the console. 
